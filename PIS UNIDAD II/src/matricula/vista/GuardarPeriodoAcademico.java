...
public class GuardarPeriodoAcademico extends javax.swing.JFrame {
    ...
    private ModeloTablaPeriodoAcademico mtp = new ModeloTablaPeriodoAcademico();
    private PeriodoAcademicoControl periodoAcademicoControl = new PeriodoAcademicoControl();
    ...
    public GuardarPeriodoAcademico(Docente usuario) {
        initComponents();
        cargarTabla();
        this.setLocationRelativeTo(null);
        pnlAzul.setIcon(new ImageIcon("fotos/Azul.png"));
