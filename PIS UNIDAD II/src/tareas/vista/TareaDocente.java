...
import static tareas.vista.TareaEstudiante.txtDescripcion;
import static tareas.vista.TareaEstudiante.txtTitulo;
...
public class TareaDocente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 570, -1, -1));
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 510, -1, -1));

        btnAbrirTarea.setBackground(new java.awt.Color(255, 255, 255));
        btnAbrirTarea.setForeground(new java.awt.Color(255, 153, 153));
        btnAbrirTarea.setText("ABRIR TAREA");
        btnAbrirTarea.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnAbrirTareaActionPerformed(evt);
            }
        });
        jPanel1.add(btnAbrirTarea, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 540, -1, -1));
    ...
    private void btnAbrirTareaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAbrirTareaActionPerformed
        AbrirTareaDocente a1=new AbrirTareaDocente();
        a1.setVisible(true);
        this.dispose();
